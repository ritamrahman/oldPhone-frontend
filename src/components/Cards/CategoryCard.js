    ...
    <Link to={`/category/${index}`}>
      <div className="flex max-w-md overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
        <div
          ...
          style={{
            backgroundImage: 'url("https://seeklogo.com/images/V/vivo-mobile-phones-logo-6C28635F1B-seeklogo.com.png")',
          }}
        />
        <div className="w-2/3 p-4 md:p-4">
          <h1 className="text-2xl font-bold text-baseSecondary">VIVO</h1>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Total Product - 220</p>
